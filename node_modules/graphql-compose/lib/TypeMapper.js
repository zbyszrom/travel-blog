...
class TypeMapper {
  ...
  convertOutputType(composeType) {
    if (this.schemaComposer.hasInstance(composeType, _TypeComposer.TypeComposer)) {
      ...
      return composeType;
    } else if (composeType instanceof _TypeComposer.TypeComposer) {
  ...
  convertOutputFieldConfig(composeFC, fieldName = '', typeName = '') {
    ...
    } else if (composeFC instanceof _TypeComposer.TypeComposer || composeFC instanceof _EnumTypeComposer.EnumTypeComposer || composeFC instanceof _InterfaceTypeComposer.InterfaceTypeComposer || composeFC instanceof _UnionTypeComposer.UnionTypeComposer || composeFC instanceof _ScalarTypeComposer.ScalarTypeComposer) {
      return {
    ...
    } else if (composeType instanceof _TypeComposer.TypeComposer || composeType instanceof _EnumTypeComposer.EnumTypeComposer || composeType instanceof _InterfaceTypeComposer.InterfaceTypeComposer || composeType instanceof _UnionTypeComposer.UnionTypeComposer || composeType instanceof _ScalarTypeComposer.ScalarTypeComposer) {
