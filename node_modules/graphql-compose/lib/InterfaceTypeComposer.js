...
class InterfaceTypeComposer {
  ...
  static createTemp(typeDef) {
    ...
    if ((0, _is.isString)(typeDef)) {
      ...
      throw new Error('You should provide GraphQLInterfaceTypeConfig or string with interface name or SDL definition');
    }
  ...
  getFieldExtensions(fieldName) {
    ...
    if ((0, _is.isObject)(field) && !(0, _is.isFunction)(field) && !Array.isArray(field) && !(0, _TypeComposer.isComposeOutputType)(field)) {
