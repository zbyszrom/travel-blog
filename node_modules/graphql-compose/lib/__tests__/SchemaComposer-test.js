...
describe('SchemaComposer', () => {
  ...
  describe('getAnyTC()', () => {
    it('should return TypeComposer', () => {
      ...
      expect(sc.getAnyTC('Object1')).toBeInstanceOf(_TypeComposer.TypeComposer);
      sc.add(new _graphql.GraphQLObjectType({
        name: 'Object2',
        fields: () => ({})
      }));
      expect(sc.getAnyTC('Object2')).toBeInstanceOf(_TypeComposer.TypeComposer);
    });
    it('should return InputTypeComposer', () => {
      const sc = new _.SchemaComposer();
  ...
  describe('add()', () => {
    it('should add TypeComposer', () => {
      ...
      expect(sc.get('Object')).toBeInstanceOf(_TypeComposer.TypeComposer);
    });
  ...
  describe('addAsComposer()', () => {
    it('should add TypeComposer', () => {
      ...
      expect(sc.get('Object1')).toBeInstanceOf(_TypeComposer.TypeComposer);
      expect(sc.get('Object2')).toBeInstanceOf(_TypeComposer.TypeComposer);
      expect(sc.get('Object3')).toBeInstanceOf(_TypeComposer.TypeComposer);
    });
    it('should return InputTypeComposer', () => {
      const sc = new _.SchemaComposer();
  ...
  describe('addTypeDefs', () => {
    ...
    it('should parse cross referenced types from SDL', () => {
      ...
      const PostInAuthor = sc.TypeComposer.createTemp(sc.get('Author')).getFieldTC('posts').getType();
      expect(Post).toBe(PostInAuthor); // Author type should be the same instance

      const Author = sc.get('Author');
      const AuthorInPost = sc.TypeComposer.createTemp(sc.get('Post')).getFieldTC('author').getType();
  ...
  describe('createTC helper methods', () => {
    it('createObjectTC()', () => {
      ...
      expect(tc).toBeInstanceOf(_TypeComposer.TypeComposer);
      expect(tc.hasField('f')).toBeTruthy();
      const tc2 = sc.createTC(`type B { f: Int }`);
      expect(tc2).toBeInstanceOf(_TypeComposer.TypeComposer);
