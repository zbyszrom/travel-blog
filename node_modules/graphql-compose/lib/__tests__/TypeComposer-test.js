...
describe('TypeComposer', () => {
  ...
  describe('interfaces manipulation', () => {
    ...
    it('hasInterface() should work by name or ITC', () => {
      ...
      expect(tc.hasInterface(MyIface)).toBeTruthy();
      expect(tc.hasInterface(_.InterfaceTypeComposer.create(MyIface))).toBeTruthy();
      tc.addInterface(_.InterfaceTypeComposer.create('MyIface123'));
  ...
  describe('check isTypeOf methods', () => {
    it('check methods setIstypeOf() getIstypeOf()', () => {
      const tc1 = _.schemaComposer.createTC('type A { f: Int }');
    ...
    /*#__PURE__*/
    _asyncToGenerator(function* () {
      const tc1 = _.schemaComposer.createTC('type A { a: Int }');

      tc1.setIsTypeOf(source => {
        return source && source.kind === 'A';
      });

      const tc2 = _.schemaComposer.createTC('type B { b: Int }');
  ...
  describe('InputType convert methods', () => {
    ...
    it('setInputTypeComposer()', () => {
      const itc1 = _.InputTypeComposer.createTemp(`Input`);
    ...
    it('getInputTypeComposer()', () => {
      ...
      expect(itc).toBeInstanceOf(_.InputTypeComposer); // must return the same instance!
