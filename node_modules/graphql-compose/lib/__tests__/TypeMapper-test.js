...
describe('TypeMapper', () => {
  ...
  describe('convertOutputFieldConfig()', () => {
    describe('converting field type', () => {
      ...
      it('should create field with Scalar type from GraphQL Schema Language', () => {
        const fc = _.TypeMapper.convertOutputFieldConfig('scalar MyScalar');
      ...
      it('should accept ScalarTypeComposer', () => {
        const stc = _.ScalarTypeComposer.create('scalar UInt');
        ...
        const fc2 = _.TypeMapper.convertOutputFieldConfig(stc);
  ...
  describe('convertInputFieldConfig()', () => {
    ...
    it('should create field with Scalar type from GraphQL Schema Language', () => {
      const fc = _.TypeMapper.convertInputFieldConfig('scalar MyInput');
    ...
    it('should accept ScalarTypeComposer', () => {
      const stc = _.ScalarTypeComposer.create('scalar MySca');
      ...
      const ic2 = _.TypeMapper.convertInputFieldConfig(stc);
  ...
  describe('convertArgConfig()', () => {
    ...
    it('should create arg config with Scalar type from GraphQL Schema Language', () => {
      const fc = _.TypeMapper.convertArgConfig('scalar Abc');
    ...
    it('should accept ScalarTypeComposer', () => {
      const stc = _.ScalarTypeComposer.create('scalar Aaa');
      ...
      const ac2 = _.TypeMapper.convertArgConfig(stc);
  ...
  describe('parseTypesFrom... methods', () => {
    ...
    it('parseTypesFromString() should strictly accept `schema` definition', () => {
      const ts = _.TypeMapper.parseTypesFromString(`
        schema {
          query: Query
          mutation: Mutation
      ...
      expect(() => {
        _.TypeMapper.parseTypesFromString(`schema { query: ErrName }`);
      }).toThrow("Incorrect type name 'ErrName' for 'query'");
      expect(() => {
        _.TypeMapper.parseTypesFromString(`schema { mutation: ErrName }`);
      }).toThrow("Incorrect type name 'ErrName' for 'mutation'");
      expect(() => {
        _.TypeMapper.parseTypesFromString(`schema { subscription: ErrName }`);
      }).toThrow("Incorrect type name 'ErrName' for 'subscription'");
    });
    it('parseTypesFromString() should strictly accept `scalar` definition', () => {
      const ts = _.TypeMapper.parseTypesFromString(`scalar MyScalar`);

      expect(ts.get('MyScalar')).toBeInstanceOf(_graphql.GraphQLScalarType);
    });
    it('parseTypesFromString() should accept `union` definition', () => {
      ...
      expect(TypeAB).toBeInstanceOf(_graphql.GraphQLUnionType);
