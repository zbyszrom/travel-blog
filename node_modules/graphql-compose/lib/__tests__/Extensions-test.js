...
describe('Extensions', () => {
  describe('TypeComposer', () => {
    it('has type Extensions methods', () => {
      const typeComposer = _.TypeComposer.create({
        name: 'Foo',
        fields: {
          id: 'ID!',
          name: 'String'
    ...
    it('has type extension initializers', () => {
      ...
      expect(typeComposer.getExtensions()).toEqual({
        tags: ['generated']
      });
    });
  ...
  describe('InputTypeComposer', () => {
    it('has type Extensions methods', () => {
      const typeComposer = _.InputTypeComposer.create({
        name: 'Foo',
        fields: {
          id: 'ID!',
          name: 'String'
  ...
  describe('InterfaceTypeComposer', () => {
    it('has type Extensions methods', () => {
      const typeComposer = _.InterfaceTypeComposer.create({
        name: 'Foo',
        fields: {
          id: 'ID!',
          name: 'String'
  ...
  describe('EnumTypeComposer', () => {
    it('has type Extensions methods', () => {
      const typeComposer = _.EnumTypeComposer.create({
        name: 'Foo',
        values: {
          FOO: {
            value: 'FOO'
  ...
  describe('UnionTypeComposer', () => {
    it('has type Extensions methods', () => {
      const foo = _.TypeComposer.create({
        name: 'Foo',
        fields: {
          id: 'ID!',
          name: 'String'
      ...
      const typeComposer = _.UnionTypeComposer.create({
        name: 'FooUnion',
        types: [foo]
      });
  ...
  describe('ScalarTypeComposer', () => {
    it('has type Extensions methods', () => {
      const typeComposer = _.ScalarTypeComposer.create({
        name: 'Foo',
