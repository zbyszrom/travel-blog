...
describe('UnionTypeComposer', () => {
  ...
  beforeEach(() => {
    ...
    utc = new _.UnionTypeComposer(objectType);
  });
  describe('create() [static method]', () => {
    it('should create Union by typeName as a string', () => {
      const myUTC = _.UnionTypeComposer.create('UnionStub');

      expect(myUTC).toBeInstanceOf(_.UnionTypeComposer);
    ...
    it('should create Union by type template string', () => {
      const myUTC = _.UnionTypeComposer.create(`
      ...
      _.TypeComposer.create('type A { a: Int }');

      _.TypeComposer.create('type B { b: Int }');
    ...
    it('should create UTC by UnionTypeConfig', () => {
      ...
      _.TypeComposer.create(`type BB { b: Int }`);
    ...
    it('should create UTC by GraphQLUnionType', () => {
      ...
      const myUTC = _.UnionTypeComposer.create(objType);
  ...
  describe('types manipulation', () => {
    ...
    describe('addType()', () => {
      ...
      it('should add by type name', () => {
        ...
        _.TypeComposer.create('SomeType');
    ...
    describe('setTypes()', () => {
      ...
      it('should set types in different ways', () => {
        ...
        _.TypeComposer.create('type DD { a: Int }');
  ...
  describe('typeResolvers methods', () => {
    ...
    it('hasTypeResolver()', () => {
      ...
      expect(utc.hasTypeResolver(_.TypeComposer.create('NewOne'))).toBeFalsy();
    });
    it('getTypeResolvers()', () => {
    ...
    describe('check native resolveType methods', () => {
      ...
      /*#__PURE__*/
      _asyncToGenerator(function* () {
        const aTC = _.schemaComposer.createTC('type A { a: Int }');

        const bTC = _.schemaComposer.createTC('type B { b: Int }');
