...
describe('typeHelpers', () => {
  describe('getComposeTypeName()', () => {
    ...
    it('understands compose types', () => {
      expect((0, _typeHelpers.getComposeTypeName)(_.schemaComposer.TypeComposer.create('TypeTC'))).toBe('TypeTC');
      expect((0, _typeHelpers.getComposeTypeName)(_.schemaComposer.InputTypeComposer.create('TypeITC'))).toBe('TypeITC');
    });
  });
});