...
function isComposeOutputType(type) {
  return (0, _graphql.isType)(type) || Array.isArray(type) && isComposeOutputType(type[0]) || type instanceof _Resolver.Resolver || type instanceof TypeComposer || type instanceof _InterfaceTypeComposer.InterfaceTypeComposer || type instanceof _EnumTypeComposer.EnumTypeComposer || type instanceof _UnionTypeComposer.UnionTypeComposer || type instanceof _ScalarTypeComposer.ScalarTypeComposer;
} // Compose Args -----------------------------
  ...
  static createTemp(typeDef) {
    ...
    if ((0, _is.isString)(typeDef)) {
      ...
      const type = new _graphql.GraphQLObjectType(_objectSpread({}, typeDef, {
        fields: (0, _is.isFunction)(fields) ? () => (0, _configAsThunk.resolveOutputConfigMapAsThunk)(this.schemaComposer, fields(), typeDef.name) : () => ({})
      }));
      TC = new this.schemaComposer.TypeComposer(type);
