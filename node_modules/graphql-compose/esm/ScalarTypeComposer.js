...
export class ScalarTypeComposer {
  ...
  static createTemp(typeDef) {
    ...
    if (isString(typeDef)) {
      ...
      if (NAME_RX.test(typeName)) {
        STC = new this.schemaComposer.ScalarTypeComposer(new GraphQLScalarType({
          name: typeName,
          serialize: () => {}
        }));
      } else {
      ...
      throw new Error('You should provide GraphQLScalarTypeConfig or string with scalar name or SDL');
    }
  ...
  clone(newTypeName) {
    ...
    const cloned = new this.schemaComposer.ScalarTypeComposer(new GraphQLScalarType({
      name: newTypeName,
