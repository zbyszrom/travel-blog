...
export class TypeMapper {
  ...
  convertOutputFieldConfig(composeFC, fieldName = '', typeName = '') {
    ...
    } else if (composeFC instanceof TypeComposer || composeFC instanceof EnumTypeComposer || composeFC instanceof InterfaceTypeComposer || composeFC instanceof UnionTypeComposer || composeFC instanceof ScalarTypeComposer) {
      return {
    ...
    } else if (composeType instanceof TypeComposer || composeType instanceof EnumTypeComposer || composeType instanceof InterfaceTypeComposer || composeType instanceof UnionTypeComposer || composeType instanceof ScalarTypeComposer) {
