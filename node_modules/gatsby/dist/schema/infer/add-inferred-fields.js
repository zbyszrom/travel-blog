...
const _require2 = require(`./is-file`),
      isFile = _require2.isFile;

const _require3 = require(`../resolvers`),
      link = _require3.link,
      fileByPath = _require3.fileByPath;

const _require4 = require(`../types/date`),
      isDate = _require4.isDate,
      dateResolver = _require4.dateResolver;
...
const getFieldConfigFromFieldNameConvention = ({
  ...
  if (linkedTypes.length > 1) {
    ...
    type = schemaComposer.getOrCreateUTC(typeName, utc => {
      const types = linkedTypes.map(typeName => schemaComposer.getOrCreateTC(typeName));
      utc.setTypes(types);
    ...
    case `object`:
      ...
      /* && depth < MAX_DEPTH*/
          ...
          if (typeComposer.hasField(key) && getNamedType(typeComposer.getFieldType(key)) instanceof GraphQLObjectType) {
            ...
            fieldTypeComposer = schemaComposer.TypeComposer.createTemp(createTypeName(selector));
          }
